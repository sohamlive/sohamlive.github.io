...
<figure>
	<img src="{{ '/assets/img/201810-random/random-1.jpg' | prepend: site.baseurl }}" alt=""> 
...
<figure>
	<img src="{{ '/assets/img/201810-random/random-2.jpg' | prepend: site.baseurl }}" alt=""> 
...
<figure>
	<img src="{{ '/assets/img/201810-random/random-3.jpg' | prepend: site.baseurl }}" alt=""> 
...
<figure>
	<img src="{{ '/assets/img/201810-random/random-4.jpg' | prepend: site.baseurl }}" alt=""> 
...
<figure>
	<img src="{{ '/assets/img/201810-random/random-5.jpg' | prepend: site.baseurl }}" alt=""> 
...
<figure>
	<img src="{{ '/assets/img/201810-random/random-6.jpg' | prepend: site.baseurl }}" alt=""> 
...
<figure>
	<img src="{{ '/assets/img/201810-random/random-7.jpg' | prepend: site.baseurl }}" alt=""> 
